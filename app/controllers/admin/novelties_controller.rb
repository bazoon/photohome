class Admin::NoveltiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @novelty.save
        format.html { redirect_to admin_novelties_path, notice: 'Novelty was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @novelty.update(novelty_params)
        format.html { redirect_to admin_novelties_path, notice: 'Novelty was successfully updated.' }
  ...
  def destroy
    @novelty.destroy
    respond_to do |format|
      format.html { redirect_to admin_novelties_path }
      format.json { head :no_content }
    end
  end
