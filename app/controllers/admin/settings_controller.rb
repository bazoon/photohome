class Admin::SettingsController < Admin::BaseController
  before_action :set_admin_setting, only: [:show, :edit, :index, :update, :destroy]
  ...
  private
    ...
    def admin_setting_params
      params[:admin_setting].permit(:album_id,:novelty_id,:article_count,:articles,:article_id, :footer, :adult_image)
    end
end
